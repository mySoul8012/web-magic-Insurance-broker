...
public class PingAnMysql implements Pipeline {
  ...
  public void process(ResultItems resultItems, Task task) {
    ...
    try {
      ...
      String sql = "insert into PingAnInfoNew" + " values(" +  "\""+ pingAnInfo.getName() + "\"" + "," + "\"" +pingAnInfo.getLocalhost() + "\"" + "," +  "\"" +pingAnInfo.getCompany() + "\"" +"," +  "\""  +pingAnInfo.getCompanyLocalhost() +  "\"" + "," + "\"" + pingAnInfo.getPhone() + "\"" + "," +  "\"" + pingAnInfo.getWeiChat() +  "\"" + "," +  "\""  + pingAnInfo.getQqNumber() +  "\"" + "," + "\""  +  pingAnInfo.getSelf()  +  "\"" + "," +  "\""  + pingAnInfo.getUrl() +  "\"" + ")";
